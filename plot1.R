plot1 <- function(strFilePath=getwd(), DOWNLD_UNZIP = TRUE, USE_INET2 = FALSE) {
  ...
  ## The problem specifies years 1999, 2002, 2005, and 2008.  However, there is no need to select by year, as these are the only years
  ## included in the data. So, no need to subset the data here.  
